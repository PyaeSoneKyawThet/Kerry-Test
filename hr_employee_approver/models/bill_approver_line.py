...
class BillApproverLine(models.Model):
    _name = 'bill.approver.line' 
    _description = "Bill Approver Line"
    ...
    def _create_activity(self):
        for bill_approver in self:
            for user in bill_approver.approval_user_ids:
                bill_approver.account_move_id.activity_schedule(
