...
class VendorPaymentApproverLine(models.Model):
    _name = 'vendor.payment.approver.line'
    _description = "Vendor Payment Approver Line"
    ...
    payment_id = fields.Many2one('account.payment', string="Vendor Payment",
    ...
    def _create_activity(self):
        for v_pay_approver in self:
            for user in v_pay_approver.approval_user_ids:
                v_pay_approver.payment_id.activity_schedule(
