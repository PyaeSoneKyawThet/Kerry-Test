...
class AccountBankStatementLine(models.Model):
    ...
    def _onchange_amount(self):
        ...
        elif self.date and self.currency_id != self.env.company.currency_id:            
    ...
    #     vals = super(AccountBankStatementLine, self)._prepare_move_line_default_vals(counterpart_account_id=counterpart_account_id)
    ...
    #     if vals:
    #         vals[:1][0]['debit'] = company_amount > 0 and company_amount or 0.0
    #         vals[:1][0]['credit'] =  company_amount < 0 and -company_amount or 0.0

    #         vals[1:][0]['debit'] = -company_amount if company_amount < 0.0 else 0.0
    #         vals[1:][0]['credit'] = company_amount if company_amount > 0.0 else 0.0
